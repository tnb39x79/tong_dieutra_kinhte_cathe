...
import 'package:gov_statistics_investigation_economic/modules/dashboard_module/download_model_ai/widgets/ai_model_section_widget_v2.dart';
...
import 'enhanced_ai_download_controller.dart' hide ModelType;
...
class EnhancedAiDownloadScreenV2
    extends GetView<EnhancedAiDownloadControllerV2> {
  const EnhancedAiDownloadScreenV2({super.key});
