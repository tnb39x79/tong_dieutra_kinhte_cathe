...
import 'question_phieu_mau_controller.dart';
 

class QuestionPhieuMauScreen extends GetView<QuestionPhieuMauController> {
  const QuestionPhieuMauScreen({super.key});
  ...
  buildPhanINganhTM(QuestionCommonModel mainQuestion, {String? subName}) {
    return Obx(() {
      var a1TValue =
      ...
      if (controller.tblPhieuNganhTMSanPham != null &&
        ...
        if (mainQuestion.danhSachCauHoiCon != null &&
          ...
          return Column(
              children:
                  controller.tblPhieuNganhTMSanPham.map<Widget>((product) {
            List<QuestionCommonModel> questionsCon =
                mainQuestion.danhSachCauHoiCon!;
            var questionA1T = questionsCon
              ...
              children: [
                if (product.sTT_SanPham! == controller.sttProduct.value)
                  ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        QuestionCommonModel questionC = questionsCon[index];
                        return buildPhanINganhTMItem(questionC, product);
                      })
                else
                  Obx(() {
                    return Container(
                                  ...
                                  child: Column(
                                      ...
                                      children: [
                                        Row(
                                          ...
                                          children: [
                                            Text(
                                              "Sản phẩm thứ ${product.sTT_SanPham}",
                                              style: const TextStyle(
                                                fontSize: 18,
                                                fontWeight: FontWeight.bold,
                                                color: Color.fromARGB(
      ...
      case "A1":
        return Column(
          ...
          children: [
            ...
            buildPhanINganhTMSubItem(question, product)
          ],
        );
  ...
  buildPhanINganhTMSubItem(
    ...
    if (question.danhSachCauHoiCon!.isNotEmpty) {
      ...
      return ListView.builder(
          ...
          itemBuilder: (context, index) {
            QuestionCommonModel questionConItem = questionCon[index];
            return renderPhanINganhTMType(questionConItem, product);
          });
    }
    return const SizedBox();
  }

  renderPhanINganhTMType(
      QuestionCommonModel question, TablePhieuNganhTMSanPham product) {
    if (question.maCauHoi == "A1_1") {
      var a5_1_1 = controller.getValueSanPham(tablePhieuMauTBSanPham,
